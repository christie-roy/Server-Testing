...
1.  Your API must be able to **create** and **delete** a _resource_ of your choosing. x
1.  Write a minimum of two tests per route handler. x
1.  Add tests to verify that the endpoints return the correct HTTP status codes. x
